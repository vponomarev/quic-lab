...
QUIC VPN поддерживает TCP и произвольный IPv4 UDP через QUIC DATAGRAM; HTTPS — TCP и IPv4 UDP поверх WebSocket/TCP. AmneziaWG поддерживает TCP/UDP. IPv6 не поддерживается.
